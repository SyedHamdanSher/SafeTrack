...
public class signupservlet extends HttpServlet
{
	...
	public static void registerCustomer(String firstName, String emailId,String eemailId, String phoneNumber)
	{
		try
		{
			...
			conn = DriverManager.getConnection("jdbc:mysql://zsayed1.cbag1ah2rou0.us-west-2.rds.amazonaws.com:3306/demon?autoReconnect=true&useSSL=false", "admin", "password");
