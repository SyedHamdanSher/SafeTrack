...
var numbers = [{'name':'Ahmed Sayed', 'contact':'+17737032688'},{'name':'Hamdan Sayed', 'contact':'+16304077735'}   ];
console.log(numbers[0].contact);
...
var info = test[1];//= JSON.stringify(test);
numbers =[];
numbers = test[0];
 ...
 for(var i = 0; i<=numbers.length; i++) {
    client.messages.create({
      //url: "https://handler.twilio.com/twiml/EH580a87163d69afbaf9788f963f3ba3c6",
        ...
        from: "+18472609524",
        body: "Hi "+numbers[i].name+",\n Ahmed needs help with "+info[0].key+".\nCurrent location of Ahmed is: "+info[0].address,
